...
Date: 2026-04-22 (updated 2026-04-23 after upstream merge)

## Status

**🎉 COMPLETE — patch merged into OpenWrt mainline.**

- Upstream PR: [openwrt/openwrt#23047](https://github.com/openwrt/openwrt/pull/23047) — merged
- Merge commit on `main`: [`6cbb072b57e9`](https://github.com/openwrt/openwrt/commit/6cbb072b57e9d72d07097902d975f8a13b768e72)
- Merged by: @robimarko (qualcommax maintainer)
- Backport to `openwrt-25.12` requested by @georgemoussalem, pending at maintainer
- No review change-requests; merged as-submitted
